...
export default async function handler(req, res) {
  ...
  const rows = [
    ...
    [],
    ["总览", "请求数", "总 Token", "总花费", "节省金额", "成功率", "团队余额"],
    ...
    [],
    ["成员消耗"],
    ["成员", "角色", "今日请求", "今日 Token", "今日花费", "本月 Token", "本月花费", "累计花费", "成功率", "额度"],
    ...(data.members || []).map((member) => [
      ...
      member.limit?.enabled ? `${member.limit.limitType}/${member.limit.limitUnit}/${member.limit.limitAmount}` : "不限额",
    ]),
    [],
    ["模型消耗"],
    ["模型", "请求数", "Token", "花费"],
