        ...
        <div style={{ maxWidth: 420, margin: "0 auto", padding: "60px 24px" }}>
          ...
          {step === "form" && (
            <>
              <p style={{ textAlign: "center", color: "var(--page-sub)", fontSize: 15, marginTop: 10 }}>
                注册即送 $20 API 体验额度，可先测试 API 是否跑通
              </p>
          ...
          {step === "done" && (
            <div style={{ textAlign: "center", marginTop: 40 }}>
              ...
              <p style={{ color: "var(--page-sub)", fontSize: 15 }}>邮箱验证成功，$20 API 体验额度已发放到你的账户。下一步先创建 API Key，马上跑通第一次真实调用。</p>
          ...
          <div className="terms-modal-backdrop" onClick={(e) => { if (e.target === e.currentTarget) setPrivacyModal(false); }}>
            <div className="terms-modal">
              ...
              <div className="terms-modal-body">
                ...
                <h3>四、数据安全</h3>
                <p>我们采用 TLS 加密传输、密码哈希存储、API Key 完整值展示、访问权限控制等措施保护您的数据。</p>
                <h3>五、用户权利</h3>
