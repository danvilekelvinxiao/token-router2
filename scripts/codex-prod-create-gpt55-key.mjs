...
const model = models.find((m) => m.publicModelId === 'flowapi-gpt55' || m.id === 'flowapi-gpt55' || m.publicModelId === 'gpt-5.5' || m.id === 'gpt-5.5');
if (!model) throw new Error('gpt55 model not found');
