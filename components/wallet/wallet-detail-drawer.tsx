...
import { formatWalletCny, formatWalletDate, formatWalletTokens } from "@/lib/wallet/format-wallet";
...
export default function WalletDetailDrawer({ open, onClose, data, loading = false, focusTitle = "钱包与套餐详情" }: WalletDetailDrawerProps) {
  ...
  return (
    <div className="wallet-drawer-backdrop" role="presentation" onMouseDown={onClose}>
      <aside className="wallet-detail-drawer" role="dialog" aria-modal="true" aria-label="钱包与套餐详情" onMouseDown={(event) => event.stopPropagation()}>
