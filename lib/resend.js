...
import net from "net";
import tls from "tls";
import { DEFAULT_FROM, normalizeFromHeader } from "@/lib/email-from";

const RESEND_API_KEY = process.env.RESEND_API_KEY;
const EMAIL_FROM = normalizeFromHeader(process.env.EMAIL_FROM || process.env.RESEND_FROM_EMAIL, DEFAULT_FROM);
const SMTP_HOST = process.env.SMTP_HOST;
const SMTP_PORT = Number(process.env.SMTP_PORT || 587);
const SMTP_USER = process.env.SMTP_USER;
const SMTP_PASS = process.env.SMTP_PASS;
const SMTP_FROM = normalizeFromHeader(process.env.SMTP_FROM || EMAIL_FROM, EMAIL_FROM);
