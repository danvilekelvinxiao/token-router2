export const MODEL_CATALOG = [
  ...
  },
  {
    ...
    actualModelId: process.env.SUB2API_MODEL_GPT55 || process.env.FLOWAPI_GPT55_ACTUAL_MODEL || process.env.FLOWAPI_UNIAPI_GPT55_ACTUAL_MODEL || "gpt-5.5",
    ...
    latency: "中等",
    quality: 99,
    routeKeywords: ["gpt-5.5", "chatgpt", "chatgpt5.5", "chatgpt55", "复杂推理", "专业代码", "agent"],
  },
  {
    name: "GPT-5.4",
  ...
  },
  {
    ...
    key: "flowapi-claude-opus-48",
    provider: "Anthropic",
    modelId: "flowapi-claude-opus-48",
    actualModelId: process.env.FLOWAPI_CLAUDE_OPUS_48_ACTUAL_MODEL || process.env.FLOWAPI_UNIAPI_CLAUDE_OPUS_48_ACTUAL_MODEL || "",
    bestFor: "最新 Opus 路线，适合高难度推理、深度分析和复杂 Agent 任务",
    inputPrice: Number(process.env.FLOWAPI_CLAUDE_OPUS_48_INPUT_CNY_PER_M || process.env.FLOWAPI_CLAUDE_OPUS_INPUT_CNY_PER_M || 6),
    outputPrice: Number(process.env.FLOWAPI_CLAUDE_OPUS_48_OUTPUT_CNY_PER_M || process.env.FLOWAPI_CLAUDE_OPUS_OUTPUT_CNY_PER_M || 24),
    latency: "中等",
    quality: 99,
    routeKeywords: ["claude", "opus4.8", "opus 4.8", "高难度", "agent", "深度分析"],
    isAvailable: Boolean(
      process.env.FLOWAPI_CLAUDE_OPUS_48_ACTUAL_MODEL
      || process.env.FLOWAPI_UNIAPI_CLAUDE_OPUS_48_ACTUAL_MODEL
      || process.env.FLOWAPI_CLAUDE_OPUS_48_AVAILABLE === "true"
      || process.env.NEXT_PUBLIC_CLAUDE_OPUS_48_AVAILABLE === "true"
    ),
  },
  {
    ...
    latency: "中等",
    quality: 98,
    routeKeywords: ["claude", "opus", "opus4.7", "推理", "分析", "专业", "高难度", "深度"],
    isAvailable: Boolean(process.env.FLOWAPI_CLAUDE_OPUS_ACTUAL_MODEL || process.env.FLOWAPI_UNIAPI_CLAUDE_OPUS_ACTUAL_MODEL),
  },
  {
    name: "Claude Opus 4.6",
    key: "flowapi-claude-opus-46",
    provider: "Anthropic",
    modelId: "flowapi-claude-opus-46",
    actualModelId: process.env.FLOWAPI_CLAUDE_OPUS_46_ACTUAL_MODEL || process.env.FLOWAPI_UNIAPI_CLAUDE_OPUS_46_ACTUAL_MODEL || "",
    bestFor: "稳定的 Opus 路线，适合旧版兼容验证与高质量复杂任务",
    inputPrice: Number(process.env.FLOWAPI_CLAUDE_OPUS_46_INPUT_CNY_PER_M || process.env.FLOWAPI_CLAUDE_OPUS_INPUT_CNY_PER_M || 6),
    outputPrice: Number(process.env.FLOWAPI_CLAUDE_OPUS_46_OUTPUT_CNY_PER_M || process.env.FLOWAPI_CLAUDE_OPUS_OUTPUT_CNY_PER_M || 24),
    latency: "中等",
    quality: 97,
    routeKeywords: ["claude", "opus4.6", "opus 4.6", "兼容", "高质量", "复杂任务"],
    isAvailable: Boolean(
      process.env.FLOWAPI_CLAUDE_OPUS_46_ACTUAL_MODEL
      || process.env.FLOWAPI_UNIAPI_CLAUDE_OPUS_46_ACTUAL_MODEL
      || process.env.FLOWAPI_CLAUDE_OPUS_46_AVAILABLE === "true"
      || process.env.NEXT_PUBLIC_CLAUDE_OPUS_46_AVAILABLE === "true"
    ),
  },
  {
    name: "Gemini 2.5 Pro",
...
const PUBLIC_MODEL_REQUEST_ALIASES = {
  ...
  "flowapi-claude-opus-48": "claude-opus-4.8",
  "flowapi-claude-opus-47": "claude-opus-4.7",
  "flowapi-claude-opus-46": "claude-opus-4.6",
...
export function normalizeModelLookup(value = "") {
  ...
  const aliases = {
    ...
    "flowapi-gpt55-pro": "flowapi-gpt55",
    "gpt-5.5-pro": "gpt-5.5",
    "gpt-5-5-pro": "gpt-5.5",
    "gpt55": "gpt-5.5",
    "gpt5.5": "gpt-5.5",
    ...
    "claude-opus-4-7": "flowapi-claude-opus",
    "flowapi-claude-opus-48": "flowapi-claude-opus-48",
    "opus4.8": "flowapi-claude-opus-48",
    "opus-4.8": "flowapi-claude-opus-48",
    "claude-opus-4.8": "flowapi-claude-opus-48",
    "claude-opus-4-8": "flowapi-claude-opus-48",
    "flowapi-claude-opus-47": "flowapi-claude-opus",
    "opus4.7": "flowapi-claude-opus",
    "opus-4.7": "flowapi-claude-opus",
    "flowapi-claude-opus-46": "flowapi-claude-opus-46",
    "opus4.6": "flowapi-claude-opus-46",
    "opus-4.6": "flowapi-claude-opus-46",
    "claude-opus-4.6": "flowapi-claude-opus-46",
    "claude-opus-4-6": "flowapi-claude-opus-46",
...
export function getCatalogModel(modelId) {
  ...
  return (
    MODEL_CATALOG.find((item) => [item.modelId, item.actualModelId, item.key]
      .filter(Boolean)
      .some((value) => String(value).toLowerCase() === key))
    || MODEL_CATALOG.find((item) => String(item.name || "").toLowerCase() === key)
    || null
  );
}
