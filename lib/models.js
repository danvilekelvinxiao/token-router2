export const MODEL_CATALOG = [
  ...
  },
  {
    ...
    key: "codex-plus",
    provider: "FlowAPI",
    modelId: "flowapi-code-lite",
    actualModelId: "deepseek-chat",
    bestFor: "Codex、Cursor、Claude Code 轻量编程任务",
    inputPrice: 0.21,
    outputPrice: 0.42,
    latency: "快",
    quality: 90,
    routeKeywords: ["codex", "cursor", "claude code", "代码", "编程", "脚本", "自动化"],
  },
  {
    name: "Qwen3 32B",
    key: "qwen",
...
export function getCatalogModel(modelId) {
  ...
  if (!id) return null;
  return MODEL_CATALOG.find((item) => item.modelId === id || item.actualModelId === id) || null;
}
