...
export function getDeployInfo() {
  ...
  return {
    ...
    configured: {
      ...
      newApiRuntimeKey: Boolean(process.env.NEW_API_KEY || process.env.NEW_API_KEY_ALL_MODELS || process.env.SUB2API_API_KEY || process.env.SUB2API_API_KEY_SECONDARY),
      ...
      aicardsApiKey: Boolean(process.env.AICARDS_API_KEY || process.env.AICARDS_API_KEY_NON_CLAUDE),
      aicardsClaudeApiKey: Boolean(process.env.AICARDS_API_KEY_CLAUDE || process.env.AICARDS_CLAUDE_API_KEY),
