const defaultPublicApiBaseUrl = "https://flowapi.fun/v1";
const forbiddenPublicApiBasePattern = /aicards|openrouter|uniapi|aheapi|newapi|new-api|sub2api|localhost:3001|127\.0\.0\.1:3001|localhost:8080|127\.0\.0\.1:8080/i;
