...
import { sanitizePublicModelProvider } from "./public-model-provider";
...
const MODEL_OFFICIAL_DISPLAY_NAMES = {
  ...
  "gpt55-pro": "GPT-5.5",
  "flowapi-gpt55-pro": "GPT-5.5",
  gpt55: "GPT-5.5",
  "flowapi-gpt55": "GPT-5.5",
  "gpt54-pro": "GPT-5.4",
  "flowapi-gpt54-pro": "GPT-5.4",
  gpt54: "GPT-5.4 mini",
...
export function seedContentCMS() {
  ...
  const models = [
    ...
    { id: "gpt54-pro", displayName: "GPT-5.4", provider: "OpenAI", modelId: "flowapi-gpt54-pro", logo: "", description: "适合高质量推理、代码审查和专业办公任务。", inputPricePerM: 14.4, outputPricePerM: 57.6, showPrice: true, categories: ["all", "gpt", "code-programming"], tags: ["ChatGPT", "代码审查", "专业办公"], useCases: ["代码审查", "专业办公", "结构化输出"], isRecommended: true, isBeginnerFriendly: false, isHighValue: true, isCodeModel: true, isChineseFriendly: false, isLongContext: true, isMultimodal: false, baseUrl: "https://api.flowapi.fun/v1", primaryButtonText: "复制 Model ID", primaryButtonHref: "", secondaryButtonText: "创建 API Key", secondaryButtonHref: "/guide", enabled: true, pinned: false, sortOrder: 32, showOnHome: false, showInBeginnerGuide: false },
    ...
    { id: "gemini-flash", displayName: "Gemini 2.5 Flash", provider: "Google", modelId: "flowapi-gemini-flash", logo: "", description: "适合快速响应、内容处理、轻量多模态和高频通用任务。", inputPricePerM: 3, outputPricePerM: 12, showPrice: true, categories: ["all", "recommended", "gemini", "low-cost", "multimodal"], tags: ["快速", "多模态", "高性价比"], useCases: ["快速响应", "内容处理", "轻量多模态"], recommendedUserTypes: ["新手用户", "价格敏感用户"], isRecommended: true, isBeginnerFriendly: true, isHighValue: true, isCodeModel: false, isChineseFriendly: false, isLongContext: false, isMultimodal: true, baseUrl: "https://api.flowapi.fun/v1", primaryButtonText: "复制 Model ID", primaryButtonHref: "", secondaryButtonText: "创建 API Key", secondaryButtonHref: "/guide", enabled: true, pinned: false, sortOrder: 62, showOnHome: true, showInBeginnerGuide: true },
...
export function getContent(type) {
  const key = resolveContentType(type);
  const map = {
    models: () => store.models.filter((m) => m.enabled).map(applyModelIntro).map(sanitizePublicModelProvider).sort((a, b) => (b.pinned ? 1 : 0) - (a.pinned ? 1 : 0) || a.sortOrder - b.sortOrder),
