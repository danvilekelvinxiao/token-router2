...
export function seedContentCMS() {
  ...
  const models = [
    ...
    { id: "gpt54-pro", displayName: "GPT-5.4 Pro", provider: "OpenAI", modelId: "flowapi-gpt54-pro", logo: "", description: "适合高质量推理、代码审查和专业办公任务。", inputPricePerM: 14.4, outputPricePerM: 57.6, showPrice: true, categories: ["all", "gpt", "code-programming"], tags: ["ChatGPT", "代码审查", "专业办公"], useCases: ["代码审查", "专业办公", "结构化输出"], isRecommended: true, isBeginnerFriendly: false, isHighValue: true, isCodeModel: true, isChineseFriendly: false, isLongContext: true, isMultimodal: false, baseUrl: "https://api.flowapi.fun/v1", primaryButtonText: "复制 Model ID", primaryButtonHref: "", secondaryButtonText: "创建 API Key", secondaryButtonHref: "/guide", enabled: true, pinned: false, sortOrder: 32, showOnHome: false, showInBeginnerGuide: false },
    { id: "gpt54", displayName: "GPT-5.4", provider: "OpenAI", modelId: "flowapi-gpt54", logo: "", description: "适合通用 ChatGPT 类体验、办公问答和结构化任务。", inputPricePerM: 12, outputPricePerM: 48, showPrice: true, categories: ["all", "gpt"], tags: ["ChatGPT", "通用问答", "办公"], useCases: ["通用问答", "办公总结", "结构化输出"], isRecommended: false, isBeginnerFriendly: true, isHighValue: true, isCodeModel: false, isChineseFriendly: false, isLongContext: false, isMultimodal: false, baseUrl: "https://api.flowapi.fun/v1", primaryButtonText: "复制 Model ID", primaryButtonHref: "", secondaryButtonText: "创建 API Key", secondaryButtonHref: "/guide", enabled: true, pinned: false, sortOrder: 34, showOnHome: false, showInBeginnerGuide: true },
    ...
    { id: "gemini-pro", displayName: "Gemini Pro", provider: "Google", modelId: "flowapi-gemini-pro", logo: "", description: "适合多模态理解、复杂内容处理和长上下文分析。", inputPricePerM: 6, outputPricePerM: 24, showPrice: true, categories: ["all", "gemini", "long-text", "multimodal"], tags: ["多模态", "长文本", "Google"], useCases: ["多模态理解", "复杂内容处理", "长上下文分析"], recommendedUserTypes: ["开发者", "内容团队"], isRecommended: false, isBeginnerFriendly: false, isHighValue: true, isCodeModel: false, isChineseFriendly: false, isLongContext: true, isMultimodal: true, baseUrl: "https://api.flowapi.fun/v1", primaryButtonText: "复制 Model ID", primaryButtonHref: "", secondaryButtonText: "创建 API Key", secondaryButtonHref: "/guide", enabled: true, pinned: false, sortOrder: 60, showOnHome: false, showInBeginnerGuide: false },
    { id: "gemini-flash", displayName: "Gemini Flash", provider: "Google", modelId: "flowapi-gemini-flash", logo: "", description: "适合快速响应、内容处理、轻量多模态和高频通用任务。", inputPricePerM: 3, outputPricePerM: 12, showPrice: true, categories: ["all", "recommended", "gemini", "low-cost", "multimodal"], tags: ["快速", "多模态", "高性价比"], useCases: ["快速响应", "内容处理", "轻量多模态"], recommendedUserTypes: ["新手用户", "价格敏感用户"], isRecommended: true, isBeginnerFriendly: true, isHighValue: true, isCodeModel: false, isChineseFriendly: false, isLongContext: false, isMultimodal: true, baseUrl: "https://api.flowapi.fun/v1", primaryButtonText: "复制 Model ID", primaryButtonHref: "", secondaryButtonText: "创建 API Key", secondaryButtonHref: "/guide", enabled: true, pinned: false, sortOrder: 62, showOnHome: true, showInBeginnerGuide: true },
...
export function adminCreateContent(type, data) {
  ...
  const item = { ...data, id, slug: data?.slug || data?.id || id, createdAt: now(), updatedAt: now() };
