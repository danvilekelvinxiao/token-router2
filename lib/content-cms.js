...
export function seedContentCMS() {
  ...
  // --- Home Config ---
  store.homeConfig = {
    heroBadge: "FlowAPI", heroTitle: "AI API Token 企业级多模型统一调用平台", heroSubtitle: "注册即送 ¥5 体验额度，三步接入，马上使用全球 AI 模型。",
    ...
    benefits: [
      ...
      { title: "注册即送 ¥5 体验额度", description: "新用户注册即可获得 ¥5 体验额度，先用起来再决定是否充值。", icon: "🎁", enabled: true, sortOrder: 2 },
