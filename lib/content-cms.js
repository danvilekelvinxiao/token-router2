...
export function seedContentCMS() {
  ...
  // --- Home Config ---
  store.homeConfig = {
    heroBadge: "FlowAPI", heroTitle: "全球第一家 AI Token 资产管理平台", heroSubtitle: "注册即送 $ API 20 体验余额，三步接入，马上使用全球 AI 模型。",
    ...
    benefits: [
      ...
      { title: "注册即送余额", description: "新用户注册即可获得 $ API 20 体验余额，先用起来再决定是否充值。", icon: "🎁", enabled: true, sortOrder: 2 },
  ...
  store.supportConfig = {
    ...
    title: "AI 玩家交流群", description: "加入 FlowAPI 玩家交流群，获取新手接入帮助、模型使用技巧和最新福利。",
    tags: ["新人教程", "福利同步", "下载协助"],
