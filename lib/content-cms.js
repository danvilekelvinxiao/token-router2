...
import { sanitizePublicModelProvider } from "./public-model-provider.js";
...
const MODEL_OFFICIAL_DISPLAY_NAMES = {
  ...
  "ds-reasoner": "DeepSeek V4 Flash Thinking",
...
const MODEL_PUBLIC_INTROS = {
  "gpt55-pro": {
    description: "GPT-5.5 是 OpenAI 面向复杂专业工作负载的旗舰模型，适合严肃推理、专业代码、Agent 工作流和高质量方案生成。它强调可靠性、复杂任务拆解、多轮上下文保持和高难度问题处理，适合企业测试、开发者和高价值内容生产场景。",
    detailDescription: "GPT-5.5 是 OpenAI 官方旗舰模型，适合处理大规模推理、编码、结构化分析和多模态工作流，尤其适合需要更强可靠性、更长上下文和更高输出质量的任务。",
  },
  "gpt55": {
  ...
  "ds-chat": {
    description: "DeepSeek V4 Flash 是 DeepSeek 面向中文日常任务和高性价比调用的对话模型，适合中文问答、内容生成、轻量代码和日常办公。它中文友好、调用成本低，适合作为新手第一款接入模型。",
    detailDescription: "DeepSeek V4 Flash 适合中国大陆用户的日常中文场景：客服问答、小红书和短视频文案、办公总结、轻量代码解释、知识问答和低成本批量处理。它不是最高阶推理模型，但非常适合先把 API 调用、扣费和数据面板闭环跑通。",
  },
  "ds-reasoner": {
    description: "DeepSeek V4 Flash Thinking 是 DeepSeek 面向复杂推理、数学、代码逻辑和商业分析的推理模式。它适合需要更强思考链路、更明确逻辑拆解和更高准确性的任务。",
    detailDescription: "DeepSeek V4 Flash Thinking 适合复杂问题求解、代码逻辑分析、数学推导、策略分析和需要多步骤判断的任务。相比普通对话模式，它更适合深度思考场景，但响应速度和成本通常也会更高。",
  },
  "claude-sonnet": {
...
function applyModelIntro(model) {
  ...
  const shouldMigrateName = displayName && (!model.displayName || LEGACY_MODEL_DISPLAY_NAMES.has(model.displayName));
...
export function seedContentCMS() {
  ...
  // --- Models ---
  const models = [
    { id: "ds-chat", displayName: "DeepSeek V4 Flash", provider: "DeepSeek", modelId: "deepseek-chat", logo: "", description: "高性价比中文对话，适合日常问答、内容生成和轻量代码。", detailDescription: "DeepSeek 最新对话模型，支持 64K 上下文，中文理解和生成能力出色。", inputPricePerM: 3, outputPricePerM: 12, showPrice: true, categories: ["all", "recommended", "deepseek", "low-cost", "chinese-writing"], tags: ["高性价比", "中文友好", "新手推荐", "低成本"], useCases: ["中文问答", "内容生成", "轻量代码", "日常任务"], notRecommendedFor: ["复杂推理", "长文本理解"], recommendedUserTypes: ["开发者", "内容创作者", "学生"], isRecommended: true, isBeginnerFriendly: true, isHighValue: false, isCodeModel: false, isChineseFriendly: true, isLongContext: false, isMultimodal: false, baseUrl: "https://api.flowapi.fun/v1", curlExample: `curl https://api.flowapi.fun/v1/chat/completions \\\n  -H "Authorization: Bearer 你的API Key" \\\n  -H "Content-Type: application/json" \\\n  -d '{"model":"deepseek-chat","messages":[{"role":"user","content":"你好"}]}'`, primaryButtonText: "复制 Model ID", primaryButtonHref: "", secondaryButtonText: "创建 API Key", secondaryButtonHref: "/guide", enabled: true, pinned: false, sortOrder: 10, showOnHome: true, showInBeginnerGuide: true },
    { id: "ds-reasoner", displayName: "DeepSeek V4 Flash Thinking", provider: "DeepSeek", modelId: "deepseek-reasoner", logo: "", description: "复杂推理和代码逻辑，适合需要深度思考的任务。", inputPricePerM: 10, outputPricePerM: 36, showPrice: true, categories: ["all", "deepseek", "code-programming"], tags: ["推理", "代码", "深度思考"], useCases: ["复杂推理", "数学", "编程", "商业分析"], isRecommended: true, isBeginnerFriendly: false, isHighValue: false, isCodeModel: true, isChineseFriendly: false, isLongContext: false, isMultimodal: false, baseUrl: "https://api.flowapi.fun/v1", primaryButtonText: "复制 Model ID", primaryButtonHref: "", secondaryButtonText: "创建 API Key", secondaryButtonHref: "/guide", enabled: true, pinned: false, sortOrder: 20, showOnHome: false, showInBeginnerGuide: false },
    { id: "gpt55-pro", displayName: "GPT-5.5", provider: "OpenAI", modelId: "gpt-5.5-pro", logo: "", description: "适合高质量推理、复杂方案、专业代码和 Agent 工作流。", inputPricePerM: 24, outputPricePerM: 96, showPrice: true, categories: ["all", "recommended", "gpt", "code-programming"], tags: ["ChatGPT", "高阶推理", "专业代码"], useCases: ["复杂方案", "专业代码", "Agent 工作流"], recommendedUserTypes: ["开发者", "企业测试用户", "高质量内容团队"], isRecommended: true, isBeginnerFriendly: false, isHighValue: true, isCodeModel: true, isChineseFriendly: false, isLongContext: true, isMultimodal: false, baseUrl: "https://api.flowapi.fun/v1", primaryButtonText: "复制 Model ID", primaryButtonHref: "", secondaryButtonText: "创建 API Key", secondaryButtonHref: "/guide", enabled: true, pinned: true, sortOrder: 4, showOnHome: true, showInBeginnerGuide: false },
    { id: "codex-plus", displayName: "GPT-5.3-Codex", provider: "OpenAI", modelId: "gpt-5.3-codex-plus", logo: "", description: "代码生成、修复和 Agent 编程任务，适合开发工具集成。", inputPricePerM: 14.4, outputPricePerM: 57.6, showPrice: true, categories: ["all", "recommended", "codex", "code-programming"], tags: ["代码", "Agent", "Coding 推荐"], useCases: ["代码生成", "Bug修复", "项目重构", "Agent"], recommendedUserTypes: ["开发者", "Cursor 用户", "Claude Code 用户"], isRecommended: true, isBeginnerFriendly: false, isHighValue: true, isCodeModel: true, isChineseFriendly: false, isLongContext: false, isMultimodal: false, baseUrl: "https://api.flowapi.fun/v1", primaryButtonText: "复制 Model ID", primaryButtonHref: "", secondaryButtonText: "创建 API Key", secondaryButtonHref: "/guide", enabled: true, pinned: true, sortOrder: 5, showOnHome: true, showInBeginnerGuide: false },
    { id: "codex-pro", displayName: "GPT-5.3-Codex", provider: "OpenAI", modelId: "gpt-5.3-codex-pro", logo: "", description: "更高阶的 Agent 编程和项目级代码任务入口。", inputPricePerM: 21.6, outputPricePerM: 86.4, showPrice: true, categories: ["all", "codex", "code-programming"], tags: ["复杂代码", "Agent", "项目重构"], useCases: ["复杂代码", "项目级重构", "专业调试"], recommendedUserTypes: ["专业开发者", "企业测试用户"], isRecommended: true, isBeginnerFriendly: false, isHighValue: true, isCodeModel: true, isChineseFriendly: false, isLongContext: false, isMultimodal: false, baseUrl: "https://api.flowapi.fun/v1", primaryButtonText: "复制 Model ID", primaryButtonHref: "", secondaryButtonText: "创建 API Key", secondaryButtonHref: "/guide", enabled: true, pinned: false, sortOrder: 6, showOnHome: false, showInBeginnerGuide: false },
    { id: "codex-lite", displayName: "GPT-5.3-Codex", provider: "OpenAI", modelId: "gpt-5.3-codex-lite", logo: "", description: "轻量编程入口，适合日常代码问答、脚本生成、简单修复。", inputPricePerM: 7.2, outputPricePerM: 28.8, showPrice: true, categories: ["all", "recommended", "codex", "code-programming", "low-cost"], tags: ["轻量代码", "低成本", "新手推荐"], useCases: ["代码问答", "脚本生成", "简单修复"], recommendedUserTypes: ["新手开发者", "价格敏感用户"], isRecommended: true, isBeginnerFriendly: true, isHighValue: true, isCodeModel: true, isChineseFriendly: false, isLongContext: false, isMultimodal: false, baseUrl: "https://api.flowapi.fun/v1", primaryButtonText: "复制 Model ID", primaryButtonHref: "", secondaryButtonText: "创建 API Key", secondaryButtonHref: "/guide", enabled: true, pinned: false, sortOrder: 7, showOnHome: true, showInBeginnerGuide: true },
    { id: "gpt55", displayName: "GPT-5.5", provider: "OpenAI", modelId: "gpt-5.5", logo: "", description: "适合复杂问答、方案规划和高质量内容生成。", inputPricePerM: 16, outputPricePerM: 64, showPrice: true, categories: ["all", "recommended", "gpt"], tags: ["高级", "推理", "长上下文"], useCases: ["复杂问答", "内容生成", "方案规划"], recommendedUserTypes: ["开发者", "内容工作室", "ChatGPT 替代用户"], isRecommended: true, isBeginnerFriendly: false, isHighValue: true, isCodeModel: false, isChineseFriendly: false, isLongContext: true, isMultimodal: false, baseUrl: "https://api.flowapi.fun/v1", primaryButtonText: "复制 Model ID", primaryButtonHref: "", secondaryButtonText: "创建 API Key", secondaryButtonHref: "/guide", enabled: true, pinned: false, sortOrder: 30, showOnHome: true, showInBeginnerGuide: false },
    { id: "gpt54-pro", displayName: "GPT-5.4", provider: "OpenAI", modelId: "gpt-5.4-pro", logo: "", description: "适合高质量推理、代码审查和专业办公任务。", inputPricePerM: 14.4, outputPricePerM: 57.6, showPrice: true, categories: ["all", "gpt", "code-programming"], tags: ["ChatGPT", "代码审查", "专业办公"], useCases: ["代码审查", "专业办公", "结构化输出"], isRecommended: true, isBeginnerFriendly: false, isHighValue: true, isCodeModel: true, isChineseFriendly: false, isLongContext: true, isMultimodal: false, baseUrl: "https://api.flowapi.fun/v1", primaryButtonText: "复制 Model ID", primaryButtonHref: "", secondaryButtonText: "创建 API Key", secondaryButtonHref: "/guide", enabled: true, pinned: false, sortOrder: 32, showOnHome: false, showInBeginnerGuide: false },
    { id: "gpt54", displayName: "GPT-5.4 mini", provider: "OpenAI", modelId: "gpt-5.4-mini", logo: "", description: "适合通用 ChatGPT 类体验、办公问答和结构化任务。", inputPricePerM: 12, outputPricePerM: 48, showPrice: true, categories: ["all", "gpt"], tags: ["ChatGPT", "通用问答", "办公"], useCases: ["通用问答", "办公总结", "结构化输出"], isRecommended: false, isBeginnerFriendly: true, isHighValue: true, isCodeModel: false, isChineseFriendly: false, isLongContext: false, isMultimodal: false, baseUrl: "https://api.flowapi.fun/v1", primaryButtonText: "复制 Model ID", primaryButtonHref: "", secondaryButtonText: "创建 API Key", secondaryButtonHref: "/guide", enabled: true, pinned: false, sortOrder: 34, showOnHome: false, showInBeginnerGuide: true },
    { id: "gpt4o-mini", displayName: "GPT-4o mini", provider: "OpenAI", modelId: "gpt-4o-mini", logo: "", description: "高性价比 ChatGPT 类体验，适合轻量推理与日常问答。", inputPricePerM: 0.18, outputPricePerM: 0.72, showPrice: true, categories: ["all", "recommended", "gpt", "low-cost"], tags: ["低成本", "ChatGPT", "新手推荐"], useCases: ["轻量推理", "日常问答", "文本处理"], recommendedUserTypes: ["新手用户", "价格敏感用户"], isRecommended: true, isBeginnerFriendly: true, isHighValue: true, isCodeModel: false, isChineseFriendly: false, isLongContext: false, isMultimodal: false, baseUrl: "https://api.flowapi.fun/v1", primaryButtonText: "复制 Model ID", primaryButtonHref: "", secondaryButtonText: "创建 API Key", secondaryButtonHref: "/guide", enabled: true, pinned: false, sortOrder: 36, showOnHome: true, showInBeginnerGuide: true },
    { id: "claude-sonnet", displayName: "Claude Sonnet 4.6", provider: "Anthropic", modelId: "claude-sonnet-4.6", logo: "", description: "长文本理解、代码分析和高质量写作。", inputPricePerM: 2.4, outputPricePerM: 9.6, showPrice: true, categories: ["all", "recommended", "claude", "long-text", "code-programming"], tags: ["长文本", "推理", "写作"], useCases: ["长文本理解", "代码分析", "写作"], recommendedUserTypes: ["Claude Code 用户", "开发者", "内容团队"], isRecommended: true, isBeginnerFriendly: false, isHighValue: true, isCodeModel: true, isChineseFriendly: false, isLongContext: true, isMultimodal: false, baseUrl: "https://api.flowapi.fun/v1", primaryButtonText: "复制 Model ID", primaryButtonHref: "", secondaryButtonText: "创建 API Key", secondaryButtonHref: "/guide", enabled: true, pinned: false, sortOrder: 50, showOnHome: true, showInBeginnerGuide: false },
    { id: "claude-opus", displayName: "Claude Opus 4.7", provider: "Anthropic", modelId: "claude-opus-4.7", logo: "", description: "适合深度分析、专业写作和高难度任务。", inputPricePerM: 6, outputPricePerM: 24, showPrice: true, categories: ["all", "claude", "long-text"], tags: ["高质量", "深度分析", "专业写作"], useCases: ["深度分析", "专业写作", "高难度任务"], recommendedUserTypes: ["企业测试用户", "高价值用户"], isRecommended: false, isBeginnerFriendly: false, isHighValue: true, isCodeModel: true, isChineseFriendly: false, isLongContext: true, isMultimodal: false, baseUrl: "https://api.flowapi.fun/v1", primaryButtonText: "复制 Model ID", primaryButtonHref: "", secondaryButtonText: "创建 API Key", secondaryButtonHref: "/guide", enabled: true, pinned: false, sortOrder: 52, showOnHome: false, showInBeginnerGuide: false },
    { id: "gemini-pro", displayName: "Gemini 2.5 Pro", provider: "Google", modelId: "gemini-2.5-pro", logo: "", description: "适合多模态理解、复杂内容处理和长上下文分析。", inputPricePerM: 6, outputPricePerM: 24, showPrice: true, categories: ["all", "gemini", "long-text", "multimodal"], tags: ["多模态", "长文本", "Google"], useCases: ["多模态理解", "复杂内容处理", "长上下文分析"], recommendedUserTypes: ["开发者", "内容团队"], isRecommended: false, isBeginnerFriendly: false, isHighValue: true, isCodeModel: false, isChineseFriendly: false, isLongContext: true, isMultimodal: true, baseUrl: "https://api.flowapi.fun/v1", primaryButtonText: "复制 Model ID", primaryButtonHref: "", secondaryButtonText: "创建 API Key", secondaryButtonHref: "/guide", enabled: true, pinned: false, sortOrder: 60, showOnHome: false, showInBeginnerGuide: false },
    { id: "gemini-flash", displayName: "Gemini 2.5 Flash", provider: "Google", modelId: "gemini-2.5-flash", logo: "", description: "适合快速响应、内容处理、轻量多模态和高频通用任务。", inputPricePerM: 3, outputPricePerM: 12, showPrice: true, categories: ["all", "recommended", "gemini", "low-cost", "multimodal"], tags: ["快速", "多模态", "高性价比"], useCases: ["快速响应", "内容处理", "轻量多模态"], recommendedUserTypes: ["新手用户", "价格敏感用户"], isRecommended: true, isBeginnerFriendly: true, isHighValue: true, isCodeModel: false, isChineseFriendly: false, isLongContext: false, isMultimodal: true, baseUrl: "https://api.flowapi.fun/v1", primaryButtonText: "复制 Model ID", primaryButtonHref: "", secondaryButtonText: "创建 API Key", secondaryButtonHref: "/guide", enabled: true, pinned: false, sortOrder: 62, showOnHome: true, showInBeginnerGuide: true },
...
export function getContent(type) {
  const key = resolveContentType(type);
  const map = {
    models: () => sortModelsForDisplay(store.models.filter((m) => m.enabled).map(applyModelIntro).map(sanitizePublicModelProvider)),
...
export function adminGetContent(type) {
  const key = resolveContentType(type);
  const map = {
    models: () => sortModelsForDisplay(store.models),
