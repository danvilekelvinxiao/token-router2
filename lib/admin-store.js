...
function adminStore() {
  if (!globalThis.__TOKEN_ROUTER_ADMIN__) {
    globalThis.__TOKEN_ROUTER_ADMIN__ = {
      channels: [
        { id: "ch_01", name: "DeepSeek 官方", provider: "DeepSeek", type: "OpenAI 兼容", baseUrl: "https://api.deepseek.com", path: "/v1", apiKey: "sk-ds-demo-full", models: ["deepseek-chat", "deepseek-reasoner"], weight: 10, timeout: 30, retry: true, fallback: "ch_03", costInput: 0.5, costOutput: 2.0, priceMultiplier: 2.0, status: "active" },
      ],
      routingRules: [
