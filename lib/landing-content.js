export const apiBaseUrl = "https://flowapi.fun/v1";
...
export const valueCards = [
  {
    title: "快速响应",
    text: "优化入口访问与上游调度，日常请求更稳，首字返回更快。",
  },
  {
    title: "多模型统一调用",
  ...
  {
    title: "充值即用",
    text: "支持人民币充值 Token、余额查看、调用统计与成本记录。",
  },
  {
    title: "配置简单",
    text: "复制 Base URL 与 API 密匙，就能接入 OpenAI 兼容客户端。",
  },
];
...
export const quickSteps = [
  ...
  },
  {
    step: "02",
    title: "创建 API 密匙",
    text: "创建 API 密匙，支持多个 API 密匙管理。",
  },
  {
    step: "03",
    title: "导入 CC Switch",
    text: "自动填入 Base URL、模型和 API 密匙，几分钟完成接入。",
  },
];
