...
export const MODEL_PRODUCTS = [
  ...
  {
    id: "codex-plus",
    displayName: "GPT5.3 Codex Plus",
    publicModelId: "gpt-5.3-codex-plus",
  ...
  {
    id: "codex-pro",
    displayName: "GPT5.3 Codex Pro",
    publicModelId: "gpt-5.3-codex-pro",
  ...
  {
    id: "codex-lite",
    displayName: "GPT5.3 Codex Lite",
    publicModelId: "gpt-5.3-codex-lite",
  ...
  },
  {
    ...
    actualModelId: process.env.FLOWAPI_CLAUDE_SONNET_ACTUAL_MODEL || process.env.FLOWAPI_UNIAPI_CLAUDE_SONNET_ACTUAL_MODEL || "claude-sonnet-4-6",
    ...
    sortOrder: 55,
    provider: "Anthropic",
    underlyingRoute: CLAUDE_SONNET_AVAILABLE ? (process.env.FLOWAPI_CLAUDE_SONNET_ACTUAL_MODEL || "claude-sonnet-4-6") : "上游未开通",
  },
  {
    id: "flowapi-claude-opus",
    displayName: "Claude Opus 4.7",
    publicModelId: "claude-opus-4.7",
    actualModelId: process.env.FLOWAPI_CLAUDE_OPUS_ACTUAL_MODEL || process.env.FLOWAPI_UNIAPI_CLAUDE_OPUS_ACTUAL_MODEL || "claude-opus-4-7",
    group: "claude-premium",
    executionGroup: process.env.NEW_API_CLAUDE_EXECUTION_GROUP || process.env.NEW_API_OPENAI_EXECUTION_GROUP || "claude-premium",
    planId: "claude-premium",
    ...
    sortOrder: 60,
    provider: "Anthropic",
    underlyingRoute: CLAUDE_OPUS_AVAILABLE ? (process.env.FLOWAPI_CLAUDE_OPUS_ACTUAL_MODEL || "claude-opus-4-7") : "上游未开通",
  },
  {
    id: "flowapi-gpt55-pro",
    displayName: "GPT5.5 Pro",
    publicModelId: "gpt-5.5-pro",
  ...
  },
  {
    ...
    displayName: "GPT5.4 Pro",
    publicModelId: "gpt-5.4-pro",
  ...
  },
  {
    ...
    publicModelId: "gemini-2.5-flash",
...
export function normalizeModelProduct(product) {
  ...
  return {
    ...
    featured: validated.featured ?? validated.pinned ?? validated.hot ?? validated.recommended,
    providerFamily: validated.providerFamily || "",
    releaseDate: validated.releaseDate || validated.officialReleaseDate || "",
    popularityScore: Number(validated.popularityScore || 0),
...
export function listModelProducts({ includeUnavailable = true } = {}) {
  return sortModelsForDisplay(MODEL_PRODUCTS
    .filter((item) => includeUnavailable || item.isAvailable)
    .map((item) => ({
      ...item,
      displayOrder: item.displayOrder ?? item.sortOrder,
      featured: item.featured ?? item.pinned ?? item.hot ?? item.recommended,
      providerFamily: item.providerFamily,
      releaseDate: item.releaseDate || item.officialReleaseDate || "",
