...
const HAS_ANY_TEXT_UPSTREAM =
  Boolean(process.env.SUB2API_BASE_URL || process.env.SUB2API_INTERNAL_URL) ||
  Boolean(process.env.NEW_API_BASE_URL) ||
  Boolean(process.env.OPENROUTER_API_KEY) ||
  Boolean(process.env.AICARDS_API_KEY) ||
  Boolean(process.env.AHEAPI_API_KEY) ||
  Boolean(process.env.UNIAPI_API_KEY) ||
...
export const MODEL_PRODUCTS = [
  ...
  {
    id: "codex-lite",
    displayName: "GPT-5.3-Codex Lite",
