...
export const MODEL_PRODUCTS = [
  ...
  },
  {
    ...
    publicModelId: "codex-auto-review",
    actualModelId: "codex-auto-review",
    group: "codex-plus",
    executionGroup: process.env.NEW_API_CODEX_EXECUTION_GROUP || "codex-plus",
    planId: "codex-plus",
    description: "代码审查和自动化代码分析模型，基于 ChatGPT Plus OAuth 渠道，适合 Codex 替代方案。",
    useCases: ["代码审查", "自动化分析", "Agent 工作流", "代码修复"],
    recommendedTools: ["CC-Switch", "Cursor", "Claude Code"],
    priceMultiplier: 1.8,
    isAvailable: true,
    isComingSoon: false,
    sortOrder: 22,
    provider: "OpenAI",
    underlyingRoute: "codex-auto-review",
  },
  {
    id: "codex-lite",
