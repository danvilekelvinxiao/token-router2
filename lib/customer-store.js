...
const SEED_ADMIN_PASSWORD = process.env.FLOWAPI_SEED_ADMIN_PASSWORD || "flowapi-local-dev-only";
...
export async function createApiKey(customerId, label = "API Key", expiresAt = null, modelProductInput = null) {
