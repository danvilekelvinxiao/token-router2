...
if (isProduction && !connectionString) {
  throw new Error("生产环境必须配置唯一数据库连接（DATABASE_URL 或 POSTGRES_URL）");
}
  ...
  if (!initPromise) {
    initPromise = activePool.query(`
      CREATE TABLE IF NOT EXISTS customers (
        ...
        total_spend NUMERIC(20, 6) NOT NULL DEFAULT 0,
      ...
      ALTER TABLE calls ADD COLUMN IF NOT EXISTS source_type TEXT NOT NULL DEFAULT 'API_CONSUME';
      ALTER TABLE calls ADD COLUMN IF NOT EXISTS source_name TEXT NOT NULL DEFAULT 'API 调用消费';
      ALTER TABLE calls ADD COLUMN IF NOT EXISTS description TEXT NOT NULL DEFAULT '';
      ALTER TABLE calls ADD COLUMN IF NOT EXISTS delivery_status TEXT NOT NULL DEFAULT '';
      ALTER TABLE calls ADD COLUMN IF NOT EXISTS billing_status TEXT NOT NULL DEFAULT '';
      ALTER TABLE calls ADD COLUMN IF NOT EXISTS related_request_id TEXT NOT NULL DEFAULT '';
      ...
      ALTER TABLE relay_request_audits ADD COLUMN IF NOT EXISTS billing_flow_status TEXT NOT NULL DEFAULT '';
      ...
      ALTER TABLE call_finalizations ADD COLUMN IF NOT EXISTS billing_status TEXT NOT NULL DEFAULT 'settled';
      ALTER TABLE call_finalizations ADD COLUMN IF NOT EXISTS delivery_confirmed_at TIMESTAMPTZ;
      ALTER TABLE call_finalizations ADD COLUMN IF NOT EXISTS settled_at TIMESTAMPTZ;
      ALTER TABLE call_finalizations ADD COLUMN IF NOT EXISTS error_reason TEXT NOT NULL DEFAULT '';
      ...
      ALTER TABLE recharge_orders ADD COLUMN IF NOT EXISTS currency TEXT NOT NULL DEFAULT '$ API';
      ...
      CREATE INDEX IF NOT EXISTS idx_relay_request_audits_created_at ON relay_request_audits(created_at DESC);
      CREATE INDEX IF NOT EXISTS idx_relay_request_audits_customer_id ON relay_request_audits(customer_id);
      CREATE INDEX IF NOT EXISTS idx_relay_request_audits_response_id ON relay_request_audits(response_id);
      ...
      ALTER TABLE activity_logs ADD COLUMN IF NOT EXISTS source_type TEXT NOT NULL DEFAULT 'HISTORICAL';
      ALTER TABLE activity_logs ADD COLUMN IF NOT EXISTS source_name TEXT NOT NULL DEFAULT '历史记录';
      ALTER TABLE activity_logs ADD COLUMN IF NOT EXISTS description TEXT NOT NULL DEFAULT '';
      ALTER TABLE activity_logs ADD COLUMN IF NOT EXISTS expire_at TIMESTAMPTZ;
      ALTER TABLE activity_logs ADD COLUMN IF NOT EXISTS is_temporary BOOLEAN NOT NULL DEFAULT false;
      ...
      CREATE INDEX IF NOT EXISTS idx_activity_logs_source_type ON activity_logs(source_type, created_at DESC);
      ...
      ALTER TABLE temporary_credits ADD COLUMN IF NOT EXISTS source_type TEXT NOT NULL DEFAULT 'DAILY_LOGIN_BONUS';
      ALTER TABLE temporary_credits ADD COLUMN IF NOT EXISTS source_name TEXT NOT NULL DEFAULT '每日登录奖励';
      ALTER TABLE temporary_credits ADD COLUMN IF NOT EXISTS description TEXT NOT NULL DEFAULT '';
      ALTER TABLE temporary_credits ADD COLUMN IF NOT EXISTS is_temporary BOOLEAN NOT NULL DEFAULT true;

      CREATE INDEX IF NOT EXISTS idx_temporary_credits_customer_active ON temporary_credits(customer_id, expires_at, remaining);
      CREATE INDEX IF NOT EXISTS idx_temporary_credits_source_type ON temporary_credits(source_type, expires_at);
