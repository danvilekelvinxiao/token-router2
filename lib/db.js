...
function validateSingleDatabaseConfig() {
  if (!databaseUrl || !postgresUrl) return;
  if (normalizeConnectionString(databaseUrl) !== normalizeConnectionString(postgresUrl)) {
    throw new Error("生产环境只能保留一个数据库连接串：DATABASE_URL 或 POSTGRES_URL 二选一");
  }
}
...
export async function ensureSchema() {
  ...
  if (!initPromise) {
    initPromise = (async () => {
      ...
      try {
        await activePool.query("SELECT pg_advisory_xact_lock(hashtext('flowapi_schema_init'))");
      ...
      CREATE TABLE IF NOT EXISTS calls (
        ...
        user_charge_usd_token NUMERIC(20, 6) NOT NULL DEFAULT 0,
        package_deduct_amount NUMERIC(20, 6) NOT NULL DEFAULT 0,
        wallet_deduct_amount NUMERIC(20, 6) NOT NULL DEFAULT 0,
        balance_after NUMERIC(20, 6) NOT NULL DEFAULT 0,
        package_balance_after NUMERIC(20, 6) NOT NULL DEFAULT 0,
      ...
      ALTER TABLE calls ADD COLUMN IF NOT EXISTS user_charge_usd_token NUMERIC(20, 6) NOT NULL DEFAULT 0;
      ALTER TABLE calls ADD COLUMN IF NOT EXISTS package_deduct_amount NUMERIC(20, 6) NOT NULL DEFAULT 0;
      ALTER TABLE calls ADD COLUMN IF NOT EXISTS wallet_deduct_amount NUMERIC(20, 6) NOT NULL DEFAULT 0;
      ALTER TABLE calls ADD COLUMN IF NOT EXISTS balance_after NUMERIC(20, 6) NOT NULL DEFAULT 0;
      ALTER TABLE calls ADD COLUMN IF NOT EXISTS package_balance_after NUMERIC(20, 6) NOT NULL DEFAULT 0;
      ...
      CREATE TABLE IF NOT EXISTS user_wallets (
        ...
        cny_recharge_total NUMERIC(18, 6) NOT NULL DEFAULT 0,
        cny_paid_total NUMERIC(18, 6) NOT NULL DEFAULT 0,
        cny_refund_total NUMERIC(18, 6) NOT NULL DEFAULT 0,
        usd_token_balance NUMERIC(20, 6) NOT NULL DEFAULT 0,
        usd_token_total_obtained NUMERIC(20, 6) NOT NULL DEFAULT 0,
        usd_token_total_used NUMERIC(20, 6) NOT NULL DEFAULT 0,
        usd_token_bonus_total NUMERIC(20, 6) NOT NULL DEFAULT 0,
        usd_token_referral_total NUMERIC(20, 6) NOT NULL DEFAULT 0,
        created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
      ...
      CREATE TABLE IF NOT EXISTS wallet_transactions (
        ...
        currency TEXT NOT NULL DEFAULT 'USD_TOKEN',
      ...
      ALTER TABLE wallet_transactions ADD COLUMN IF NOT EXISTS type TEXT DEFAULT '';
      ALTER TABLE wallet_transactions ADD COLUMN IF NOT EXISTS currency TEXT NOT NULL DEFAULT 'USD_TOKEN';
      ALTER TABLE wallet_transactions ADD COLUMN IF NOT EXISTS amount NUMERIC(18, 6) NOT NULL DEFAULT 0;
      ALTER TABLE wallet_transactions ADD COLUMN IF NOT EXISTS exchange_rate NUMERIC(18, 6) NOT NULL DEFAULT 0;
      ALTER TABLE wallet_transactions ADD COLUMN IF NOT EXISTS related_user_id TEXT DEFAULT '';
      ALTER TABLE wallet_transactions ADD COLUMN IF NOT EXISTS related_order_id TEXT DEFAULT '';
      ALTER TABLE wallet_transactions ADD COLUMN IF NOT EXISTS related_call_id TEXT DEFAULT '';
      ALTER TABLE wallet_transactions ADD COLUMN IF NOT EXISTS description TEXT DEFAULT '';

      CREATE INDEX IF NOT EXISTS idx_user_wallets_updated ON user_wallets(updated_at DESC);
