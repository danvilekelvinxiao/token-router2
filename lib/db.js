  ...
  if (!initPromise) {
    initPromise = activePool.query(`
      ...
      CREATE TABLE IF NOT EXISTS calls (
        ...
        upstream_cost NUMERIC(14, 6) DEFAULT 0,
        profit NUMERIC(14, 6) DEFAULT 0,
      ...
      ALTER TABLE calls ADD COLUMN IF NOT EXISTS upstream_cost NUMERIC(14, 6) DEFAULT 0;
      ALTER TABLE calls ADD COLUMN IF NOT EXISTS profit NUMERIC(14, 6) DEFAULT 0;
