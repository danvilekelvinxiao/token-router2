import pg from "pg";
import { getPrimaryAdminEmail } from "./admin-identity";
...
const LEGACY_ADMIN_EMAIL = "xiaoyijie@flowapi.fun";
  ...
  if (!initPromise) {
    initPromise = activePool.query(`
      ...
      CREATE TABLE IF NOT EXISTS route_attempts (
        ...
        public_model_id TEXT DEFAULT '',
        requested_model TEXT DEFAULT '',
        requested_model_name TEXT DEFAULT '',
        actual_model_id TEXT DEFAULT '',
      ...
      ALTER TABLE route_attempts ADD COLUMN IF NOT EXISTS requested_model TEXT DEFAULT '';
      ALTER TABLE route_attempts ADD COLUMN IF NOT EXISTS requested_model_name TEXT DEFAULT '';
      ALTER TABLE route_attempts ADD COLUMN IF NOT EXISTS upstream_model_name TEXT DEFAULT '';
      ALTER TABLE route_attempts ADD COLUMN IF NOT EXISTS upstream_url TEXT DEFAULT '';
      ALTER TABLE route_attempts ADD COLUMN IF NOT EXISTS api_key_preview TEXT DEFAULT '';
      ...
      ALTER TABLE route_attempts ADD COLUMN IF NOT EXISTS error_kind TEXT DEFAULT '';
      ALTER TABLE route_attempts ADD COLUMN IF NOT EXISTS payment_required BOOLEAN NOT NULL DEFAULT false;
      ...
      VALUES
        ('cus_admin', 'xiaoyijie', '', 'FlowAPI', '${ADMIN_EMAIL}', '$2b$12$1QEMn00KY..kutbvO3MFtOyo3uaxEldqBV4bx1g9S3p4Y9H/uBCxa', '0001', 9999, 0, 'admin', true)
      ON CONFLICT (id) DO UPDATE SET
        name = EXCLUDED.name,
        company = EXCLUDED.company,
        email = EXCLUDED.email,
        password_hash = EXCLUDED.password_hash,
        my_invite_code = EXCLUDED.my_invite_code,
      ...
      SET role = 'admin',
          email = '${ADMIN_EMAIL}'
      WHERE id = 'cus_admin' OR lower(email) = lower('${ADMIN_EMAIL}') OR lower(email) = lower('${LEGACY_ADMIN_EMAIL}');
      ` : ""}
